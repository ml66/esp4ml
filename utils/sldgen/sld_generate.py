...
def write_acc_interface(f, acc, dma_width, rst, is_vivadohls_if):
  ...
  if not is_vivadohls_if:
    ...
    f.write("      out_V_din                  : out std_logic_vector (" + str(dma_width - 1) + " downto 0);\n")
    f.write("      out_V_full_n               : in  std_logic;\n")
    f.write("      out_V_write                : out std_logic;\n")
    f.write("      in1_V_dout                 : in  std_logic_vector (" + str(dma_width - 1) + " downto 0);\n")
    f.write("      in1_V_empty_n              : in  std_logic;\n")
    f.write("      in1_V_read                 : out std_logic;\n")
    f.write("      load_ctrl_din              : out std_logic_vector (" + str(63) + " downto 0);\n")
    f.write("      load_ctrl_full_n           : in  std_logic;\n")
    f.write("      load_ctrl_write            : out std_logic;\n")
    f.write("      store_ctrl_din             : out std_logic_vector (" + str(63) + " downto 0);\n")
...
def write_acc_signals(f, dma_width):
  ...
  f.write("signal load_ctrl_din     : std_logic_vector(63 downto 0);\n")
  f.write("signal store_ctrl_write  : std_ulogic;\n")
  f.write("signal store_ctrl_full_n : std_ulogic;\n")
  f.write("signal store_ctrl_din    : std_logic_vector(63 downto 0);\n")
  f.write("\n")
  f.write("signal dma_read_ctrl_data : std_logic_vector(63 downto 0);\n")
  f.write("signal dma_write_ctrl_data : std_logic_vector(63 downto 0);\n")
...
def write_acc_port_map(f, acc, dma_width, rst, is_noc_interface, is_vivadohls_if):
  ...
  if not is_vivadohls_if:
    ...
    f.write("      in1_V_empty_n              => load_chnl_empty_n,\n")
    f.write("      in1_V_read                 => load_chnl_read,\n")
    f.write("      in1_V_dout                 => load_chnl_data,\n")
    f.write("      out_V_write                => store_chnl_write,\n")
    f.write("      out_V_full_n               => store_chnl_full_n,\n")
    f.write("      out_V_din                  => store_chnl_data,\n")
    ...
    f.write('  dma_read_ctrl_data_size    <= "010";\n')
    ...
    f.write('  dma_write_ctrl_data_size    <= "010";\n')
    f.write("\n")
